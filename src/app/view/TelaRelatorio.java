...
public class TelaRelatorio extends JFrame implements WindowListener {
	...
	public String toStringCabecalho(){							//Tabela com o tempo
		String cabecalho ="+-----------------------------------------------------------------------------+\n"
						+ " |Time is shown in Milliseconds                                                |\n"
						+ "+-----------------------------------------------------------------------------+\n"
						+ "+    Results    |		Size	                 |\n"
						+ "+----------------+-----------------------------------------------------------+\n"
						+ " |   Method      |Bubble       |Selection  |Insertion    |Merge       |\n"
						+ "+----------------+--------------+-------------+--------------+-------------+\n";
		return cabecalho;
	}

	public void setTxtArea(String relatorio) {
		this.txtArea.setText(this.txtArea.getText() + relatorio);
	}
